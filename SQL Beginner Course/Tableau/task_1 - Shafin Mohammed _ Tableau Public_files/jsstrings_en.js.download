...
(function(w) {
  var s = {
    ...
    EmptyLayoutGridMessage: "Hold down Shift to drop objects into this container",
    EmptyLayoutStackMessage: "Hold down Shift to drop objects into this container",
    ...
    ExportExcelDialogMessage: "The Excel file has been generated",
    ExportExcelDialogTitle: "Download Excel",
    ...
    ToolbarDisabledExcelDownloadExplanation: "The Excel file is not available for download.",
